      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
              ...
              <Reveal key={p.title} delay={0.1 + i * 0.1}>
                <div className="group flex items-start gap-5">
                  <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-forest transition group-hover:bg-gold">
                    <p.icon className="h-5 w-5 text-goldlight transition group-hover:text-forest" />
                  </span>
                  <div>
          ...
          <Reveal delay={0.35} className="mt-12">
            <p className="text-[11px] font-bold uppercase tracking-[0.35em] text-gold">Our Certifications & Compliance</p>
            <div className="mt-4">
              <CertificationBadges />
            </div>
          </Reveal>
